<template>
  <section class="timeline-container timeline">
    <div @click="changeCurrentTimePoint(tweet)" v-for="tweet in tweets" class="timeline-block">
      <div class="timeline-img" :class="['timeline-img',tweet.tweetColor===undefined?'red':tweet.tweetColor]">
        <img v-if="tweet.img" :src="getImg(tweet.img)" alt="">
      </div>

      <div class="timeline-content">
        <h2 v-text="tweet.title"></h2>
        <p v-text="tweet.text"></p>
        <!-- <h3 v-text="tweet.text"></h3> -->
        <span v-if="tweet.date" class="date" v-text="tweet.date"></span>
      </div>
    </div>
  </section>
</template>
<style scoped>
  .timeline-contarting 'copy:fonts'...
[00:29:24] Starting 'copy:iconfont'...
[00:29:24] Starting 'copy:icons'...
[00:29:24] Starting 'copy:assets'...
[00:29:24] Starting 'build:index'...
[00:29:24] Starting 'build:less'...tainer {
